...
public class csImageManager : MonoBehaviour
{
    public static csImageManager Instance { get { return _Instance; } }
    private static csImageManager _Instance;
    ...
    {
        SetObserveScreen(csImageManager.Instance.observeLoadingObject);
